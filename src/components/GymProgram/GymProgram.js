...
const GymProgram = () => (
  <div css={styles} className="gymProgram">
    ...
    <Container>
      <GymProgramCard
        title="Basic Fitness"
        desc="Physical Fitness is a general state of health and well-being and, more specifically, the ability to perform aspects of sports, occupations and daily activities."
      />
      <GymProgramCard
